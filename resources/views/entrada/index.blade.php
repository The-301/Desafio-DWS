                            ...
                            <table class="table card-table table-vcenter text-nowrap datatable">
                                ...
                                <tbody>
                                    @forelse ($entradas as $i => $entrada)
                                        <tr>
                                            <td><input class="form-check-input m-0 align-middle" type="checkbox" aria-label="Select entrada"></td>
                                            <td>{{ ++$i }}</td>
                                                ...
                                                <div class="btn-list flex-nowrap">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <a class="dropdown-item" href="{{ route('entradas.show',$entrada->id) }}">
                                                                View
                                                            </a>
                                                            <a class="dropdown-item" href="{{ route('entradas.edit',$entrada->id) }}">
                                                                Edit
                                                            </a>
